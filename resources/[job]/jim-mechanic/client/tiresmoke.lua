...
RegisterNetEvent('jim-mechanic:client:Tires:Check', function()
	...
	elseif r == 255 and g == 255 and b == 255 then app2 = Loc[Config.Lan]["common"].current
	elseif r == 2 and g == 21 and b == 255 then app3 = Loc[Config.Lan]["common"].current
	elseif r == 3 and g == 83 and b == 255 then app4 = Loc[Config.Lan]["common"].current
	elseif r == 0 and g == 255 and b == 140 then app5 = Loc[Config.Lan]["common"].current
	elseif r == 94 and g == 255 and b == 1 then app6 = Loc[Config.Lan]["common"].current
	elseif r == 255 and g == 255 and b == 0 then app7 = Loc[Config.Lan]["common"].current
	elseif r == 255 and g == 150 and b == 0 then app8 = Loc[Config.Lan]["common"].current
	elseif r == 255 and g == 62 and b == 1 then app9 = Loc[Config.Lan]["common"].current
	elseif r == 255 and g == 1 and b == 1 then app10 = Loc[Config.Lan]["common"].current
	elseif r == 255 and g == 50 and b == 100 then app11 = Loc[Config.Lan]["common"].current
	elseif r == 255 and g == 5 and b == 190 then app12 = Loc[Config.Lan]["common"].current
	elseif r == 35 and g == 1 and b == 255 then app13 = Loc[Config.Lan]["common"].current
