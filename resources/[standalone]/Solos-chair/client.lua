...
local function SitInChair()
    ...
    while chairout == true do
        TaskPlayAnim(ped, 'timetable@ron@ig_3_couch', 'base', 8.0, 8.0, -1, 2, 0, false, false, false)
        AttachEntityToEntity(ChairObject, ped, GetPedBoneIndex(ped, 6442), 0.0, -0.15, -0.1, 0.0, 88.0, 96.0, false,
