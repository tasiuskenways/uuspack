...
Config.ClothingRooms = {
    ...
    {
        job = "ambulance",
        coords = vector4(307.01, -598.95, 42.27, 337.82),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(308.95, -598.04, 42.39),
            vector3(306.56, -602.65, 42.27),
            vector3(304.63, -601.93, 42.27),
            vector3(305.62, -597.33, 42.27)
        }
    },
}
