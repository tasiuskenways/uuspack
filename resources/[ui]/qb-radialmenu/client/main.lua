...
RegisterCommand('radialmenu', function()
    if ((IsDowned() and IsPolice() or IsEMS()) or not IsDowned()) and not PlayerData.metadata["ishandcuffed"] and not IsPauseMenuActive() and not inRadialMenu then
...
RegisterNetEvent('qb-radialmenu:client:openmdt', function()
    ExecuteCommand('MDT')
end)

RegisterNetEvent('qb-radialmenu:client:openphone', function()
    ExecuteCommand('phone')
end)

RegisterNetEvent('qb-radialmenu:client:refreshskin', function()
